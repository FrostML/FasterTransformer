 ...
 **/
 ...
 void masked_attention_dispatch(
   ...
   T* query_buf, const T* self_Q_bias, 
   T* key_cache, const T* self_K_bias, T* value_cache, const T* self_V_bias,
   T* context_buf, int batch_size, int head_num, int size_per_head, const int step,
   const int start_len, cudaStream_t stream)
   {
 ...
 template<OperationType OpType_>
 void OpenTransformerDecoder<OpType_>::cross_multi_head_attention(
   const DataType_* from_tensor,
 ...
 template<OperationType OpType_>
 void OpenTransformerDecoder<OpType_>::decoder_norm1(
 ...
 template<OperationType OpType_>
 void OpenTransformerDecoder<OpType_>::decoder_norm2(
   const DataType_* input,
   const DataType_* gamma,
   const DataType_* beta,
   const DataType_* bias,
 ...
 template<OperationType OpType_>
 void OpenTransformerDecoder<OpType_>::ffn(
   const DataType_* input,
   DataType_* ffn_inner,
   DataType_* output,
   const int m,
 ...
 template void OpenTransformerDecoder<OpType_>::add_bias_act(DataType_* input,
const float* bias,
int m, int n);
